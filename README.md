...
- **Downloads** — export as a PDF (generated in the browser, a real file rather than a page to print) or CSV with the same section selector as Share (Key Metrics, Ticket Trend, Breakdowns, Account Summary, Open Issues — all on by default); Account Summary is not available in CSV
